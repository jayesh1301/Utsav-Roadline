...
const DeliveryStatusReport = () => {
  ...
  const columns = [
    ...
    { field: 'ConsignNo', headerName: 'ConsignNo', flex: 1 },
    { field: ' ConsignDate', headerName: 'ConsignDate', flex: 1 },
    ...
    { field: 'LR Amount', headerName: 'LR Amount', flex: 1 },
    { field: 'Delivery date', headerName: 'Delivery date', flex: 1 },
    { field: 'Delivery Remark', headerName: 'Delivery Remark', flex: 1 },
    { field: 'Bill No', headerName: 'Bill No', flex: 1 },
    { field: 'Memo No', headerName: 'Memo No', flex: 1 },
    { field: 'Memo Date', headerName: 'Memo Date', flex: 1 },
    { field: 'Vehicle No', headerName: 'Vehicle No', flex: 1 },
    { field: 'From Office', headerName: 'From Office', flex: 1 },
    { field: 'To Office', headerName: 'To Office', flex: 1 },
  ];
